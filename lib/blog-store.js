...
const placeholderImages = new Set(["", "/images/sonicite-product.jpg", "/images/atmos-product.jpg"]);
const coverImageBySlug = {
  "why-humans-need-music": "/images/blog-1.jpg",
  "founder-confession": "/images/blog-2.jpg",
  "how-djs-find-music": "/images/blog-3.jpg",
  "why-clubs-ban-phones": "/images/blog-4.jpg",
  "dancefloor-safety": "/images/blog-4.jpg",
  "generative-ai-music-industry": "/images/blog-5.jpg",
  "music-media-evolution": "/images/blog-6.jpg",
  "mia-founder-story": "/images/founders/mia.jpg",
};

function resolveArticleImage(slug, image) {
  if (!image || placeholderImages.has(image)) {
    return coverImageBySlug[slug] || "/images/blog-1.jpg";
  }
...
function mapRowToArticle(row) {
  ...
  return {
    ...
    image: resolveArticleImage(row.slug, row.image),
    summary: row.summary ?? "",
